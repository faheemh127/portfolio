    ...
    >
      <div className="relative w-full h-full flex items-center justify-center pt-6">
        {images.slice(0, 5).map((image, index) => (
            ...
            >
              <ChevronUp className="lucide lucide-chevron-up absolute -left-[6px] -top-[6px] translate-x-[-13px] translate-y-[-13px] -rotate-45 text-indigo-700" size={40} />
              <ChevronUp className="lucide lucide-chevron-up absolute -right-[6px] -top-[6px]  translate-x-[13px] translate-y-[-13px] rotate-45 text-indigo-700" size={40} />
              <Image
                src={image}
                alt={`Web design ${index + 1}`}

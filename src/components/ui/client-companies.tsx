...
function ClientCompanies() {
  ...
  return (
    <div
      id="client-companies"
      className="px-5 h-full bottom-0 left-0 right-0 top-0 bg-[linear-gradient(to_right,rgba(79,79,79,0.07)_1px,transparent_1px),linear-gradient(to_bottom,rgba(79,79,79,0.07)_1px,transparent_1px)] bg-[size:40px_40px] w-full overflow-hidden"
    >

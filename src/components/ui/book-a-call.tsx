...
const BookACall = () => {
  return (
    <div className="shadow-[2px_3px_50px_theme(colors.indigo.700)">
      <button className="group relative grid overflow-hidden rounded-md px-4 md:px-7 py-2 md:py-3 shadow-[0_1000px_0_0_hsl(0_0%_20%)_inset] transition-colors duration-200">
        <span>
